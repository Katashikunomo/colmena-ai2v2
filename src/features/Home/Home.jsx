...
//               {/* Imagen 3D que sobresale cuando está activa */}
//               <motion.div
...
//                 animate={{ x: activeCard === index ? ["-100%", "100%"] : "-100%" }}
...
//       y: { mobile: 60, md: 90 },
//     },
//     { id: 4, image: "/team-collaboration.png", title: "Team", x: { mobile: 0, md: 0 }, y: { mobile: 120, md: 180 } },
//     {
//       id: 5,
...
//       y: { mobile: -60, md: -90 },
//     },
//     { id: 7, image: "/placeholder-mnxje.png", title: "Mobile", x: { mobile: 160, md: 260 }, y: { mobile: 0, md: 0 } },
//     {
//       id: 8,
...
//       y: { mobile: -100, md: -156 },
//     },
//     { id: 11, image: "/api-concept.png", title: "API", x: { mobile: 80, md: 130 }, y: { mobile: 100, md: 156 } },
//     {
//       id: 12,
...
//     return {
//       x: isMobile ? item.x.mobile : item.x.md,
//       y: isMobile ? item.y.mobile : item.y.md,
//     }
//   }
...
//           <motion.div
//             key={item.id}
//             className="absolute honeycomb-item"
//             style={{
...
//               transition: { duration: 0.3 },
//             }}
//             onHoverStart={() => setCenterText(item.title)}
//             onHoverEnd={() => setCenterText("Ecosistema Integrado")}
//           >
//             {/* Hexágono contenedor */}
...
//               {/* Tooltip */}
//               <motion.div
//                 className="absolute -bottom-8 md:-bottom-10 left-1/2 transform -translate-x-1/2 bg-black/90 text-white px-2 py-1 md:px-3 md:py-1 rounded-lg text-xs md:text-sm whitespace-nowrap opacity-0 pointer-events-none"
//                 whileHover={{ opacity: 1 }}
...
//     const isMobile = window.innerWidth < 768
//     return {
//       x: isMobile ? feature.x.mobile : feature.x.md,
//       y: isMobile ? feature.y.mobile : feature.y.md,
//     }
//   }
...
//           <motion.div
//             key={index}
//             className="absolute honeycomb-item interactive-element"
//             style={{
//               left: `calc(50% + ${position.x}px)`,
//               top: `calc(50% + ${position.y}px)`,
//               transform: "translate(-50%, -50%)",
...
//                   stroke="white"
//                   strokeWidth="2"
//                   filter={hoveredFeature === index ? `url(#glow-${index})` : "none"}
//                 />
//               </svg>
...
//               <div
//                 className={`w-6 h-6 md:w-8 md:h-8 rounded-lg bg-gradient-to-br ${features[hoveredFeature].color} flex items-center justify-center text-white text-xs md:text-sm mr-2 md:mr-3`}
//               >
//                 {features[hoveredFeature].icon}
//               </div>
//               <h4 className="font-bold text-xs md:text-sm">{features[hoveredFeature].title}</h4>
//             </div>
//             <p className="text-gray-300 text-xs leading-relaxed">{features[hoveredFeature].description}</p>
//           </div>
//         </motion.div>
//       )}
...
//         <motion.div
//           className="w-16 h-16 md:w-24 md:h-24 bg-gradient-to-br from-purple-600 via-purple-700 to-purple-800 rounded-full flex items-center justify-center shadow-2xl border-4 border-white/30 mb-4 mx-auto"
//           animate={{
//             rotate: [0, 360],
//             scale: hoveredFeature !== null ? 1.1 : 1,
//           }}
//           transition={{
...
//         <motion.div
//           className="absolute top-1/2 -left-8 bg-gradient-to-br from-white to-blue-50 rounded-2xl p-3 shadow-2xl border border-blue-200"
...
//       <div className="relative bg-black pt-20 md:-mt-20">
//         {/* HERO */}
//         <Section id="hero" className="overflow-hidden">
//           {/* Parallax background layer */}
//           <ParallaxLayer scrollY={scrollY} speed={0.12} className="absolute inset-0">
//             <div className="absolute inset-0 bg-gradient-to-br from-black via-purple-900/20 to-black" />
//           </ParallaxLayer>

//           {/* Particles */}
//           <ParallaxLayer scrollY={scrollY} speed={0.3} className="absolute inset-0 pointer-events-none">
//             <ConnectedParticles />
//           </ParallaxLayer>

//           {/* Foreground content */}
//           <ParallaxLayer scrollY={scrollY} speed={0.55} className="relative z-10 w-full">
...
//                     <motion.div className="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl flex items-center justify-center mr-4 shadow-2xl">
//                       <FaWhatsapp className="text-white text-2xl" />
//                     </motion.div>
//                     <h1 className="text-3xl sm:text-5xl font-bold text-white">Colmena</h1>
//                   </div>

//                   <h2 className="text-xl sm:text-3xl mb-4 text-white font-semibold">
//                     Automatización Inteligente de{" "}
//                     <span className="bg-gradient-to-r from-green-400 to-green-500 bg-clip-text text-transparent font-bold">
//                       WhatsApp Business
//                     </span>
//                   </h2>

//                   <p className="text-base sm:text-lg mb-6 text-gray-300">
//                     Transformamos tu atención al cliente con chatbots que responden 24/7, automatizan pedidos y
//                     potencian ventas.
//                   </p>

//                   <div className="flex gap-3 flex-wrap">
//                     <Button className="h-12 px-6 rounded-lg bg-gradient-to-r from-purple-600 to-purple-700 text-white shadow-lg border-none interactive-element">
//                       <FaRocket className="mr-2" /> Comenzar Ahora
//                     </Button>
//                     <Button className="h-12 px-6 rounded-lg border-2 border-purple-600 text-white bg-transparent interactive-element">
//                       <FaWhatsapp className="mr-2" /> Ver Demo
//                     </Button>
//                   </div>
//                 </motion.div>
...
//         {/* STATS */}
//         <Section id="stats" className="bg-gradient-to-br from-black via-purple-900/10 to-black">
//           <ParallaxLayer scrollY={scrollY} speed={0.15} className="absolute inset-0">
//             <ConnectedParticles />
//           </ParallaxLayer>
...
//               viewport={{ once: true }}
//             >
//               <h2 className="text-center mb-12 text-3xl sm:text-4xl font-bold text-white">
//                 Resultados que{" "}
...
//               {[
//                 { icon: <FaChartLine className="text-3xl" />, value: "300%", label: "Más Ventas", color: "purple" },
//                 { icon: <FaUsers className="text-3xl" />, value: "500+", label: "Empresas Activas", color: "green" },
//                 { icon: <FaWhatsapp className="text-3xl" />, value: "1M+", label: "Mensajes/Mes", color: "purple" },
//                 { icon: <FaRobot className="text-3xl" />, value: "24/7", label: "Disponibilidad", color: "green" },
//               ].map((stat, index) => (
//                 <motion.div
//                   key={index}
...
//                 >
//                   <Card
//                     className={`text-center rounded-2xl shadow-2xl hover:shadow-purple-500/25 transition-all duration-300 border-2 p-6 bg-gradient-to-br from-gray-900 to-black ${stat.color === "purple" ? "border-purple-500/30 hover:border-purple-400/50" : "border-green-500/30 hover:border-green-400/50"}`}
//                   >
//                     <div
//                       className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-4 ${stat.color === "purple" ? "bg-gradient-to-br from-purple-600 to-purple-700 text-white" : "bg-gradient-to-br from-green-500 to-green-600 text-white"}`}
//                     >
//                       {stat.icon}
//                     </div>
//                     <div
//                       className={`text-2xl font-bold mb-2 ${stat.color === "purple" ? "text-purple-400" : "text-green-400"}`}
//                     >
//                       {stat.value}
//                     </div>
...
//           <ParallaxLayer scrollY={scrollY} speed={0.22} className="absolute inset-0">
//             <FloatingShapes />
//           </ParallaxLayer>
...
//                 Soluciones completas de automatización de WhatsApp diseñadas para transformar la comunicación.
//               </p>
//             </motion.div>
...
//         {/* CTA FINAL */}
//         <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-900 via-black to-purple-900 overflow-hidden">
...
//                 <div className="w-20 h-20 bg-gradient-to-br from-green-400 to-green-500 rounded-3xl flex items-center justify-center shadow-2xl">
//                   <FaWhatsapp className="text-white text-3xl" />
//                 </div>
//               </div>

//               <h2 className="text-white mb-4 text-2xl sm:text-3xl font-bold">¿Listo para Automatizar tu WhatsApp?</h2>
//               <p className="text-purple-200 mb-8">
//                 Únete a más de 500 empresas que ya usan Colmena para automatizar atención y ventas 24/7.
//               </p>
...
//                   <FaRocket className="mr-2" /> Comenzar Gratis
//                 </Button>
//                 <Button className="h-14 px-8 rounded-2xl border-2 border-white text-white bg-transparent interactive-element">
...
/* =========================
   ConnectedParticles - Enhanced
   ========================= */
const ConnectedParticles = ({ enhanced = false }) => {
  const particles = Array.from({ length: enhanced ? 20 : 12 }, (_, i) => ({
    id: i,
    x: Math.random() * 100,
    y: Math.random() * 100,
      ...
      <svg className="w-full h-full">
        ...
        {particles.map((particle, i) => (
          <motion.circle
            ...
            fill="url(#particleGradient)"
            animate={{
              scale: [1, enhanced ? 2 : 1.5, 1],
              opacity: [0.4, 1, 0.4],
              cx: [`${particle.x}%`, `${(particle.x + 5) % 100}%`, `${particle.x}%`],
              cy: [`${particle.y}%`, `${(particle.y + 3) % 100}%`, `${particle.y}%`],
            }}
            transition={{
              duration: enhanced ? 3 + Math.random() * 3 : 2 + Math.random() * 2,
              repeat: Number.POSITIVE_INFINITY,
              delay: Math.random() * 2,
            }}
          />
      ...
      {/* <nav className="fixed top-0 w-full z-50 bg-black/90 backdrop-blur-md border-b border-purple-500/30">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <motion.div
                className="w-10 h-10 bg-gradient-to-br from-purple-500 to-purple-700 rounded-xl flex items-center justify-center mr-3"
            ...
            <div className="hidden md:flex space-x-8">
              {["Inicio", "Servicios", "Mejoras", "Contacto"].map((item) => (
                <motion.button
                  key={item}
                  className="text-gray-300 hover:text-purple-400 font-medium transition-colors interactive-element"
            ...
            <Button className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 border-none interactive-element">
              Comenzar Gratis
            </Button>
          </div>
        </div>
      ...
      <div className="relative bg-black pt-20 md:-mt-20">
        ...
        <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-r from-purple-900 via-black to-purple-900 overflow-hidden">
          <div className="absolute inset-0 backdrop-blur-sm bg-black/30">
            <ConnectedParticles enhanced={true} />
          </div>

          <div className="absolute inset-0 pointer-events-none">
            <motion.div
              className="absolute top-10 left-10 w-32 h-32 bg-purple-400/20 rounded-full"
              animate={{
                scale: [1, 1.5, 1],
                rotate: [0, 180, 360],
                x: [0, 50, 0],
            ...
            />
            <motion.div
              className="absolute bottom-10 right-10 w-24 h-24 bg-green-400/20 rounded-full"
              animate={{
                scale: [1, 0.8, 1.2, 1],
                y: [0, -40, 0],
                rotate: [0, -180, 0],
            ...
            />
            <motion.div
              className="absolute top-1/2 left-1/4 w-16 h-16 bg-purple-600/30 rounded-full"
              animate={{
                scale: [1, 1.8, 1],
                opacity: [0.3, 0.8, 0.3],
                rotate: [0, 360, 0],
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 px-4">
            ...
            >
              <div className="flex justify-center mb-6">
                <motion.div
                  className="w-20 h-20 bg-gradient-to-br from-green-400 to-green-500 rounded-3xl flex items-center justify-center shadow-2xl"
                  animate={{
                    rotate: [0, 5, -5, 0],
                    scale: [1, 1.1, 1],
                  }}
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                ...
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button className="h-14 px-8 rounded-2xl border-2 border-white text-white bg-transparent interactive-element hover:bg-white/10">
                    <FaShieldAlt className="mr-2" /> Solicitar Demo
                  </Button>
                </motion.div>
              </div>
